...
#%%
def get_points_info(data_frame: pd.DataFrame, columns: list, index: str, points: int):
...
a = get_points_info(data_frame = df_source, columns = cols, index = ['RecordNo'], points = 4)
